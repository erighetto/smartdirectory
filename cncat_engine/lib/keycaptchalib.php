...
* Copyright (C) 2010 ITNP, Jsc (www.keycaptcha.com). All rights reserved.
...
if ( !class_exists('KeyCAPTCHA_CLASS') )
{
	class KeyCAPTCHA_CLASS
	{
		...
		private $p_kc_js_code = "<!-- KeyCAPTCHA code (www.keycaptcha.com)--><script language='JavaScript'>var s_s_c_user_id = '1311';var s_s_c_session_id = '#KC_SESSION_ID#';var s_s_c_captcha_field_id = 'capcode';var s_s_c_submit_button_id = 'postbut';var s_s_c_web_server_sign = '#KC_WSIGN#';var s_s_c_web_server_sign2 = '#KC_WSIGN2#';</script><script language=JavaScript src='http://backs.keycaptcha.com/swfs/cap.js'></script><!-- end of KeyCAPTCHA code-->";
